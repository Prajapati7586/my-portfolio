...
function NavItem({ isActive = false, href, children }: NavItemProps) {
  return (
    <li>
      <Link
        href={href}
...
function DesktopNavigation(): React.ReactElement {
...
const AvatarContainer: React.FC<React.HTMLAttributes<HTMLDivElement>> = ({
  className,
  ...props
}) => {
  return (
